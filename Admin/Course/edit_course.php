...
<?php 
	...
	if(isset($_GET['idedep']) && isset($_GET['idecrs']) && isset($_GET['ideb']))
	{
		$sql = mysql_query("SELECT * FROM course WHERE department = '{$department}' AND course_id = '{$course_id}' AND batch = '{$batch}'");
	...
	if(isset($_POST['submit']))
		{
				$sqledit = "UPDATE course
									SET department   = '{$_POST['department']}',
										course_id   = '{$_POST['course_id']}',
										course_name = '{$_POST['course_name']}',
										batch = '{$_POST['batch']}',
										shift = '{$shift}'
									WHERE department = '{$department}' AND course_id = '{$course_id}'";
                ...
                <div class="row">
					<form action="" method="post">
						<div class="col-md-8">
							<div class="card">
								<div class="header">
									<h4 class="title">Update Course Info</h4>
								</div>
								<div class="content">
										<div class="row">
											<div class="col-md-5">
