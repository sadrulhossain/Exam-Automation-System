    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
				...
				<li>
					<a href="../TeacherSeat/dashboard.php">
						<i class="fa fa-bar-chart" aria-hidden="true"></i>
						<p>Teacher Duty Plan</p>
					</a>
				</li>
				<li>
					<a href="../StudentSeat/dashboard.php">
						<i class="fa fa-bar-chart" aria-hidden="true"></i>
						<p>Student Seat Plan</p>
					</a>
				</li>
				<li>
					<a href="../Routine/dashboard.php">
				...
				<li>
					<a href="Room/dashboard.php">
						<i class="fa fa-pencil" aria-hidden="true"></i>
						<p>Room</p>
					</a>
				</li>
				<li>
					<a href="Slot/dashboard.php">
						<i class="fa fa-pencil" aria-hidden="true"></i>
						<p>Slot</p>
					</a>
				</li>
