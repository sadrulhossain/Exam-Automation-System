...
if(isset($_POST['submit']))
	{  
		...
		$dsql = mysql_query("SELECT * FROM room WHERE room_number = '$room_number' ");		
		if(mysql_num_rows ( $dsql ) > 0 )
			{
				$success1 =  "$room_number already exists!";
			}
		else
			{
				$sql = mysql_query("INSERT INTO room(room_number, building_name, department, room_capacity)
                ...
                <div class="row">
					<form action="" method="post">
						<div class="col-md-8">
							<div class="card">
								<div class="header">
									<h4 class="title">Add Room Profile</h4>
								</div>
								<div class="content">
										<div class="row">
											<div class="col-md-5">
										...
										<div class="row">
											...
											<div class="col-md-5">
												<div class="form-group">
													...
													<input type="number" min="0" name="room_capacity" class="form-control" placeholder="Enter No. of Columns">
												</div>
											</div>											
										</div>
								</div>
